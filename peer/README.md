...
(http://godoc.org/github.com/mraksoll4/ltcd/peer)
...
```bash
$ go get -u github.com/mraksoll4/ltcd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/mraksoll4/ltcd/peer#example-package--NewOutboundPeer)  
